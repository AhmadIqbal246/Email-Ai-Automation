...
from .models import User, Company, Invitation, EmailAccount, RefreshToken
...
AI Email Automation Team
            ...
            return Response({
                'message': f'Invitation sent successfully to {email_address}',
...
class ConnectEmailView(APIView):
    ...
    def post(self, request):
        try:
            ...
            return Response({
                'message': 'Email connection initiated',
                'auth_url': 'https://example.com/oauth/email'
            })
        except Exception as e:
            return Response({
